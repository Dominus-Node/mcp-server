...
export function registerFetchTools(server, config) {
    server.tool("dominusnode_fetch", "Fetch a URL through Dominus Node's rotating proxy network. Supports geo-targeting by country/state/city. Returns response status, headers, and body. Use this for web scraping, geo-targeted requests, or avoiding IP blocks.", {
