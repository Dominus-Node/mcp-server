export function registerProxyTools(server, httpClient) {
    server.tool("dominusnode_get_proxy_config", "Get proxy endpoint configuration including HTTP/SOCKS5 endpoints, supported countries, pricing, and username format for geo-targeting.", {}, async () => {
        try {
    ...
    server.tool("dominusnode_get_proxy_status", "Get live proxy network status including latency, active session count, and uptime.", {}, async () => {
        try {
