...
export function registerPlansTools(server, httpClient) {
    ...
    server.tool("dominusnode_list_plans", "List all available pricing plans with bandwidth, connection limits, and features.", {}, async () => {
        try {
            const data = await httpClient.get("/api/plans");
